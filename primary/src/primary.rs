...
impl Primary {
    pub fn spawn(
        ...
        GarbageCollector::spawn(&name, &committee, consensus_round.clone(), rx_consensus, parameters.max_header_delay);
        ...
        Helper::spawn(committee.clone(), store, rx_cert_requests, parameters.max_header_delay);
